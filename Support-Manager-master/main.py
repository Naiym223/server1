...
async def on_message(message):
    ...
    if message.content.lower().startswith(prefix + 'tickets'):
        ...
        infotext = discord.Embed(
            ...
            color=0x37ceb2,
            url="http://discordbotserversupport.000webhostapp.com/"
        )
        infotext.set_author(
            name="Honestly Vibes | Honestly Vibes#1087",
            url="https://liba001.github.io/",
            icon_url="https://avatars0.githubusercontent.com/u/30984789?s=460&v=4"
        )
        infotext.set_thumbnail(
            url="https://media.discordapp.net/attachments/508469034044489728/508475679713787925/server.png?width=301&height=301"
        )
        infotext.add_field(
            name="Developer",
            value="Name: **Honeslty Vibes**\n"
                  "Discord: **Honestly Vibes#1087**\n"
                  "GitHub: [LiBa001](https://github.com/LiBa001)\n"
                  "I'm also at [Discordbots.org](https://discordbots.or0g/user/269959141508775937).\n"
                  "I'd be very happy if you'd support me on "
                  "[**Patreon**](https://www.patreon.com/us0r?u=8320690). :heart:\n"
                  "*Concept idea by **LiBa01#8817***",
            inline=True
        )
        infotext.add_field(
            name="Developed in:",
        ...
        infotext.add_field(
            ...
            value="Type `{0}help` to get all commands.\n"
                  "Join the [Official Support Server](https://discord.gg/cJ9qJ9A) "
...
client.run('NTA4NDY3Mjc4MDQ0NzI1MjQ4.Dr_zXw.gsz267E7_iIyQVhXggbM8Npmr-U')  # TODO: insert token
